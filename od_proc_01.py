...
simulation_dir = '/global/cfs/cdirs/m3246/ewitkowski/selected_data'
...
while current_chunk_start < args.stop_read:
    ...
    outfile_dimuons_isolation = f"/global/cfs/cdirs/m3246/rmastand/dimuonAD/data_post_fj/muons_iso_{current_chunk_start}_{current_chunk_stop}_od.dat"
